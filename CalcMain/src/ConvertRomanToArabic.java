/*
* Я делал заглушки. Это было сделано не мной, так как тут используются Collection, Enum. Темы, которые не изуычал. Код
* взят отсюда -- https://www.baeldung.com/java-convert-roman-arabic
* */
